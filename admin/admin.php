...
require_once BOGO_PLUGIN_DIR . '/admin/includes/posttype-support.php';
...
function bogo_admin_menu()
{
    ...
    $posttype_support = add_submenu_page(
        'bogo',
        __('Post Type Support', 'bogo'),
        __('Post Type Support', 'bogo'),
        'bogo_manage_language_packs',
        'bogo-posttype-support',
        'bogo_posttype_support_page'
    );
